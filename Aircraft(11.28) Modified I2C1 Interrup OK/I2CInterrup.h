#define I2C_SPEED 50000 // 400KHz, 2500ns cycle
// I2C clock is SYSCLK
#define I2C_SCK_LOW 1600*4 // SCK minimum low time in nanoseconds (originally 1300ns)
#define I2C_SCL_DEL  2000 // Delay between SDA edge and SCL rising in nanoseconds
#define I2C_SDA_DEL  2000 // Delay between SCL falling and SDA edge in nanoseconds
